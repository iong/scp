program pljmc
    ...
    integer :: i, j, n, NMC,mcblen
    namelist /ljmccfg/Natom,imass,rc,rtol,atol,taumin,NMC,mcblen,ptinterval,nstreams,Tmin,Tmax,bl,outfile,rho,rcmin,ncells
...
!    close(20)
    ...
    do i=1,nstreams
        call populate_cube(bl, rcmin, r(:,:,i))
